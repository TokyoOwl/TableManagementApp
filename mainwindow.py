...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if (self.tableDailySales.columnCount() < 5):
            self.tableDailySales.setColumnCount(5)
        #__qtablewidgetitem = QTableWidgetItem()
        #self.tableDailySales.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.tableDailySales.setHorizontalHeaderItem(0, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.tableDailySales.setHorizontalHeaderItem(1, __qtablewidgetitem2)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.tableDailySales.setHorizontalHeaderItem(2, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.tableDailySales.setHorizontalHeaderItem(3, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.tableDailySales.setHorizontalHeaderItem(4, __qtablewidgetitem5)
        ...
        if (self.tableImploees.columnCount() != 7 ):
            self.tableImploees.setColumnCount(7)
        #__qtablewidgetitem25 = QTableWidgetItem()
        #self.tableImploees.setHorizontalHeaderItem(0, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(0, __qtablewidgetitem26)
        __qtablewidgetitem27  = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(1, __qtablewidgetitem27)
        __qtablewidgetitem28  = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(2, __qtablewidgetitem28)
        __qtablewidgetitem29 = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(3, __qtablewidgetitem29)
        __qtablewidgetitem30 = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(4, __qtablewidgetitem30)
        __qtablewidgetitem31 = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(5, __qtablewidgetitem31)
        __qtablewidgetitem32 = QTableWidgetItem()
        self.tableImploees.setHorizontalHeaderItem(6, __qtablewidgetitem32)
        ...
        if (self.tableProviders.columnCount() < 1):
            self.tableProviders.setColumnCount(1)
        #__qtablewidgetitem13 = QTableWidgetItem()
        #self.tableProviders.setHorizontalHeaderItem(0, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.tableProviders.setHorizontalHeaderItem(0, __qtablewidgetitem14)
        ...
        if (self.tableSalesRes.columnCount() < 4):
            self.tableSalesRes.setColumnCount(4)
        #__qtablewidgetitem15 = QTableWidgetItem()
        #self.tableSalesRes.setHorizontalHeaderItem(0, __qtablewidgetitem15)
        __qtablewidgetitem16 = QTableWidgetItem()
        self.tableSalesRes.setHorizontalHeaderItem(0, __qtablewidgetitem16)
        __qtablewidgetitem17= QTableWidgetItem()
        self.tableSalesRes.setHorizontalHeaderItem(1, __qtablewidgetitem17)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.tableSalesRes.setHorizontalHeaderItem(2, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.tableSalesRes.setHorizontalHeaderItem(3, __qtablewidgetitem19)
        ...
        self.tableProducts.setHorizontalHeaderItem(0, __qtablewidgetitem7)
        __qtablewidgetitem8 = QTableWidgetItem()
        self.tableProducts.setHorizontalHeaderItem(1, __qtablewidgetitem8)
        __qtablewidgetitem9 = QTableWidgetItem()
        self.tableProducts.setHorizontalHeaderItem(2, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.tableProducts.setHorizontalHeaderItem(3, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        self.tableProducts.setHorizontalHeaderItem(4, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        self.tableProducts.setHorizontalHeaderItem(5, __qtablewidgetitem12)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.tableProducts.setHorizontalHeaderItem(6, __qtablewidgetitem20)
        ...
        if (self.tableProductTypes.columnCount() < 1):
            self.tableProductTypes.setColumnCount(1)
        #__qtablewidgetitem21 = QTableWidgetItem()
        #self.tableProductTypes.setHorizontalHeaderItem(0, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        self.tableProductTypes.setHorizontalHeaderItem(0, __qtablewidgetitem22)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem2 = self.tableDailySales.horizontalHeaderItem(1)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Сотрудник", None))
        ___qtablewidgetitem3 = self.tableDailySales.horizontalHeaderItem(2)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Количество, шт.", None))
        ___qtablewidgetitem4 = self.tableDailySales.horizontalHeaderItem(3)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Дата", None))
        ___qtablewidgetitem5 = self.tableDailySales.horizontalHeaderItem(4)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Сумма, руб.", None))
        ...
        ___qtablewidgetitem7 = self.tableProducts.horizontalHeaderItem(0)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", u"Тип товара", None))
        ___qtablewidgetitem8 = self.tableProducts.horizontalHeaderItem(1)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"Цена, руб.", None))
        ___qtablewidgetitem9 = self.tableProducts.horizontalHeaderItem(2)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"Количество, шт.", None))
        ___qtablewidgetitem10 = self.tableProducts.horizontalHeaderItem(3)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"Дата изготовления", None))
        ___qtablewidgetitem11 = self.tableProducts.horizontalHeaderItem(4)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", u"Срок годности, мес.", None))
        ___qtablewidgetitem12 = self.tableProducts.horizontalHeaderItem(5)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"Поставщик", None))
        ___qtablewidgetitem20 = self.tableProducts.horizontalHeaderItem(6)
        ...
        #                                                         u"ID",
        #                                                         None))
        ___qtablewidgetitem14 = self.tableProviders.horizontalHeaderItem(0)
        ...
        #                                                         u"ID",
        #                                                         None))
        ___qtablewidgetitem16 = self.tableSalesRes.horizontalHeaderItem(0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("MainWindow",
                                                                 u"Год",
                                                                 None))
        ___qtablewidgetitem17 = self.tableSalesRes.horizontalHeaderItem(1)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow",
                                                                 u"Квартал",
                                                                 None))
        ___qtablewidgetitem18 = self.tableSalesRes.horizontalHeaderItem(2)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow",
                                                                 u"Выручка, руб.",
                                                                 None))
        ___qtablewidgetitem19 = self.tableSalesRes.horizontalHeaderItem(3)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow",
                                                                 u"Чистая прибыль, руб.",
                                                                 None))
        ...
        ___qtablewidgetitem22 = self.tableProductTypes.horizontalHeaderItem(0)
